...
pythTriplesFilter : List (Int, Int, Int) -> List (Int, Int, Int)
pythTriplesFilter x = 
    List.filter isTriple x

pythTriplesFilterRec : List (Int, Int, Int) -> List (Int, Int, Int)
pythTriplesFilterRec z = 
    case z of
    [] -> 
       []
    (x :: xs) ->
        if(isTriple(x)) then
        x :: pythTriplesFilterRec((xs))
        else 
        pythTriplesFilterRec((xs))
...
my_results =
    [
        ...
        "TEST",
        pr <| pythTriplesFilter ([(9999,9999,9999),(9,40,41),(3,4,5),(1176,490,1274)]),
        pr <| pythTriplesFilterRec ([(9999,9999,9999),(3,4,5),(1176,490,1274)]),
        "\n-- end --"
    ] 

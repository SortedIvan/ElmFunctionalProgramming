module CreditCardPractice exposing (..)
...
toDigits x = 
    List.filterMap String.toInt (String.split "" x)
...
doubleSecond list = 
    case list of 
        ...
        (x :: y :: xs) ->
            if (y * 2 < 10) then
                x :: (y * 2 :: doubleSecond xs)
            else 
                x :: (((modBy 10 (y * 2)) + 1) :: doubleSecond xs)
...
my_results =
    [
        "calculations:",
        pr <| toDigits "345763240913232",
        "to digits rev",
        pr <| toDigitsRev "345763240913232",
        "-- end --",
        pr <| sumDigits (doubleSecond [3,9,9,2,1,6,2,6,7,8,9,8,2,5,4,5]),
        "is Valid Test",
        pr <| isValid "6011920409800508",
